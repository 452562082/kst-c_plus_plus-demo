...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	_Rpc_ModelInfo* _mdlinfo= engine.KvpRegisterSpeakerByStream(utt_arr, "testnode", "/tmp/asv", "djsayrwq2ry7dehswjd8");
	...
	_Rpc_TopSpeakerInfo *rt = engine.KvpIdentifyTopSpeakerByStream(utt_arr, vp_node_arr, 1, 1, 0);
	if(rt->RetCode != 0){
	...
	//删除说话人
	engine.KvpModelRemoveBySpkid("testnode", "/tmp/asv", "djsayrwq2ry7dehswjd8");
